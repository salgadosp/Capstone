...
app.layout = html.Div(children=[html.H1('SpaceX Launch Records Dashboard',
                                ...
                                dcc.Dropdown(id='site-dropdown', options=dd_options,
...
def function(entered_site, weight_range):
    if entered_site == 'ALL':
        filtered_df = spacex_df[(spacex_df['Payload Mass (kg)'] > weight_range[0]) & (spacex_df['Payload Mass (kg)'] < weight_range[1])] 
